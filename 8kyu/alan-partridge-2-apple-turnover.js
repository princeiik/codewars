...
//Solution
//P: an interger
//R: it's hotter than the sun if x**2 is more than 1000 and return honeycomb Yorkie for the glovebox if it's less than 1000. 

function apple(x){
  //create a conditional for x**2 > 1000 and vice versa
  return (x**2 > 1000) ? "It's hotter than the sun!!" : "Help yourself to a honeycomb Yorkie for the glovebox."
}

console.log(apple(30)); //'Help yourself to a honeycomb Yorkie for the glovebox.'
