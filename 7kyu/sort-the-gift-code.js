...
//Solution
//P: a string containing up to 26 unique alphbetical characters
//R: the character sorted in alphabetical order

function sortGiftCode(code){
  //turn the string into an array
  code = code.split("")
  //return the array sorted and use join to turn it back into a string
